...
public sealed class CliPresetsService
{
    ...
    private void LoadProfilePath()
    {
        ...
        try
        {
            ...
            ProfilePathOrUrl = JsonSerializer.Deserialize<PresetsData>(json, WinProvisionJsonOptions.Compact)?.ProfilePathOrUrl;
        }
        catch (JsonException)
        {
    ...
    public void SaveProfilePathOrUrl(string? value)
    {
        ...
        try
        {
            ...
            string json = JsonSerializer.Serialize(new PresetsData { ProfilePathOrUrl = ProfilePathOrUrl }, WinProvisionJsonOptions.Compact);
