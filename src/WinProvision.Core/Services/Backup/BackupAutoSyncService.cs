...
/// MarkUninstalled) — e a cada mudança agenda uma sincronização com debounce.
///
...
/// dentro do <see cref="ProfileBackupSet"/> salvo. Guias vazias (ex.: uma guia nova
/// ainda sem seleção) são ignoradas, pra não poluir o backup com perfis em branco.
///
...
/// App.xaml.cs) só para o construtor rodar e a assinatura do evento acontecer — a
