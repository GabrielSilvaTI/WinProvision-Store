...
public class ScoringWeights
{
    ...
    /// <summary>
    /// Score mínimo (0-100) para um app entrar no apps.json publicado. Abaixo disso,
    /// o app passou no NoiseFilter mas fica de fora do catálogo por baixa relevância
    /// (ex.: projeto abandonado no GitHub, sem estrelas, sem atividade recente).
    /// </summary>
    public int MinimumScoreThreshold { get; set; } = 25;
}
